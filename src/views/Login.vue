        ...
        <section class="container mx-auto pt-16 pb-4 px-4">
            ...
            <form 
                ...
                <label class="block mb-2">
                    ...
                    <input type="email" placeholder="e.g. alexsmith@example.com" v-model="email" :disabled="isSubmitting" class="block w-full rounded bg-gray-800 py-2 px-4 disabled:opacity-50" />
                </label>

                <div class="flex justify-end items-center">
                    <input type="submit" value="Login" :disabled="isSubmitting" class="incline-block bg-emerald-400 text-lg text-gray-800 font-bold uppercase rounded px-4 py-2 cursor-pointer disabled:opacity-50" />
                </div>
